<nav class="navbar navbar-expand-md navbar-light d-none d-md-flex" id="topbar">
    <div class="container-fluid">
        ...
        <div class="navbar-user">
            ...
            <!-- Avatar Login Logout Username Dropdown -->
            <div class="dropdown d-flex">
                <div class="pr-3">
                    <h4 class="">{{ auth()->user()->name }}</h4>
                    <h5 class="text-muted">{{ strtoupper(auth()->user()->role->name )}}</h5>
                </div>

                <!-- Toggle -->
                <a href="#" class="avatar avatar-sm avatar-online dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{ asset('assets/img/avatars/profiles/user_icon.png') }}" alt="..." class="avatar-img rounded-circle" />
                </a>
