                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <h1 class="header-title">
                                {{ trans('cruds.unit_types.title') }}
                            </h1>

                        </div>
                        <div class="col-auto">

                            <a class="btn btn-primary" href="{{ route('unit_types.create') }}">
                                Add {{ trans('cruds.unit_types.title_singular') }}
                            </a>
                            ...
                            <ul class="nav nav-tabs nav-overflow header-tabs">
                                <li class="nav-item">
                                    <a href="#!" class="nav-link active">
                                        All <span
                                            class="badge badge-pill badge-soft-secondary">{{ $total_unit_types }}</span>
                                    </a>
                                </li>
                                {{-- <li class="nav-item">
                                ...
                                <td class="text-right">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="{{ url('unit_types/'.$unit_type->id.'/edit') }}"
                                                class="dropdown-item">
                                                Edit
                                            </a>
                                            <form action="{{ url('unit_types/'.$unit_type->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
