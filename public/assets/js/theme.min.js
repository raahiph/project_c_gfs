...
function () {
    ...
    "undefined" != typeof Chart && e && new Chart(e, {
        ...
        data: {
            // labels: [barChartData[0][0].days,barChartData[0][1].days,barChartData[0][2].days,barChartData[0][3].days],
            labels: bar_chart_dates,
            datasets: [{
                label: "2022",
                // data: [barChartData[0][0].count,barChartData[0][1].count,barChartData[0][2].count,barChartData[0][3].count]
                data: bar_chart_counts
                // data: []
            }, {
                label: "2019",
                data: [barChartData[0][0].count,barChartData[0][1].count,barChartData[0][2].count],
...
function () {
    ...
    "undefined" != typeof Chart && e && new Chart(e, {
        ...
        data: {
            labels: ["Delivered", "Approved", "Requested"],
            datasets: [{
                data: [pieChartData[0][2], pieChartData[0][1], pieChartData[0][0]],
...
function () {
    var e = document.querySelectorAll('[data-togglFe="map"]');
    "undefined" != typeof mapboxgl && e && [].forEach.call(e, function (e) {
        ! function (e) {
            ...
            var a = {
                ...
                o = Object.assign(a, t);
            mapboxgl.accessToken = "pk.eyJ1IjoiZ29vZHRoZW1lcyIsImEiOiJjanU5eHR4N2cybDU5NGVwOHZwNGprb3E0In0.msdw9q16dh8v4azJXUdiXg", new mapbFoxgl.Map(o)
        }(e)
    })
}(),
function () {
